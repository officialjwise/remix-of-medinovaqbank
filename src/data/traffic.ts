...
export const countryTraffic: CountryTraffic[] = [
  { code: "GH", country: "Ghana", lat: 7.95, lng: -1.02, users: 4120, sessions: 18240, pct: 62.4, trend: 8.1 },
  { code: "NG", country: "Nigeria", lat: 9.08, lng: 8.68, users: 1180, sessions: 5210, pct: 17.9, trend: 12.4 },
  { code: "GB", country: "United Kingdom", lat: 55.37, lng: -3.43, users: 412, sessions: 1840, pct: 6.2, trend: 3.2 },
  { code: "US", country: "United States", lat: 37.09, lng: -95.71, users: 308, sessions: 1290, pct: 4.7, trend: -1.4 },
  { code: "KE", country: "Kenya", lat: -0.02, lng: 37.9, users: 198, sessions: 870, pct: 3.0, trend: 5.6 },
  { code: "ZA", country: "South Africa", lat: -30.56, lng: 22.94, users: 142, sessions: 610, pct: 2.2, trend: 2.1 },
  { code: "CA", country: "Canada", lat: 56.13, lng: -106.35, users: 96, sessions: 420, pct: 1.5, trend: 0.8 },
  { code: "IN", country: "India", lat: 20.59, lng: 78.96, users: 78, sessions: 320, pct: 1.2, trend: 4.0 },
];
...
export const liveActivity: LiveActivity[] = [
  ...
  { id: "3", city: "Kumasi", country: "GH", action: "completed Surgery Core — 78%", ago: "31s ago" },
