  ...
  faqs: [
    {
      ...
      answer:
        "Sign in with Google and get a 7-day free trial with sample questions across every bank — no credit card required. Your trial is locked to the device you sign up on.",
    },
    {
      id: "f2",
      category: "Billing",
      ...
      answer:
        "Yes, any time. You keep access until the end of your current billing period; we don't pro-rate refunds.",
    },
    {
      id: "f3",
      category: "Billing",
      question: "Is this in GHS (Ghana Cedis)?",
      answer:
        "All prices are in Ghana Cedis. We accept cards and mobile money via Paystack at checkout.",
    },
    {
      id: "f4",
      category: "Content",
      question: "Do I get access to all question banks?",
      answer:
        "Every paid plan unlocks the full library across Internal Medicine, Surgery, OB/GYN, Paediatrics, Pharmacology, Pathology, and more.",
    },
    {
      id: "f5",
      category: "Content",
      ...
      answer:
        "After every answer (Tutor mode) or after a session (Quiz mode), a detailed clinical breakdown explains the correct answer, why each distractor is wrong, the key learning point, and links to related concepts.",
    },
  ],
  helpArticles: [
    {
      ...
      body: "<p>Add your specialty, institution and a profile photo from the <strong>Profile</strong> page so your progress and leaderboard entry are personalised.</p>",
    },
    {
      id: "h2",
      category: "Quizzes",
      title: "Tutor mode vs Quiz mode",
      body: "<p><strong>Tutor mode</strong> shows the explanation after each question. <strong>Quiz mode</strong> mimics the real exam and reveals everything at the end.</p>",
    },
    {
      id: "h3",
      category: "Billing",
      title: "Managing your subscription",
      body: "<p>View invoices, change plans and see your renewal date from the <strong>Subscription</strong> page.</p>",
    },
  ],
  legal: {
    terms: {
